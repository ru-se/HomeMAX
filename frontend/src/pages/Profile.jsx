        ...
        <div className="min-h-screen bg-[#fff0f5] pb-28 font-kiwi-maru relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <div className="p-8 pb-4 text-center">
                    <h1 className="text-3xl md:text-3xl font-black text-[#9C6924] mb-2">プロフィール</h1>
                    <p className="text-[#9C6924] opacity-80">{user.username}さんのページ</p>
                </div>

                {/* Profile Content */}
                <div className="p-6 max-w-2xl mx-auto">
                    {/* User Info Card */}
                    <div className="bg-[#fff5f7] rounded-3xl p-6 md:p-8 shadow-lg border-2 border-dashed border-[#fbcfe8] relative mb-6">
                        <h2 className="text-xl font-black text-[#db2777] mb-4 border-b border-[#fbcfe8] pb-2">会員証</h2>
