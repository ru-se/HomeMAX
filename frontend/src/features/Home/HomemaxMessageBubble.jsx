...
const HomemaxMessageBubble = ({ message }) => {
  return (
    <div className='h-full'>
      <div
        className='
           w-60 h-9/10 max-h-9/10  border-2 border-solid relative  px-4 py-2 text-base font-normal  border-black rounded-4xl bg-pink
          ...
          after:border-y-[7.8px] after:border-l-[15.5px] after:border-y-transparent after:border-l-pink 
        '>
